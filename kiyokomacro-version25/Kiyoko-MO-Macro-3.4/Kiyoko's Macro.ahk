...
Treadmill:
    ...
    Loop,
    {
        ...
        {
            If (GetColors(237, 86, "0x2160FD", 30)) {
                Break
            }
        }
        ...
        Loop,
        {
            ...
            Switch T10 {
                case "High 1k+": ErrLevel := GetColors(49, 83, "0x5A5A5A", 40)
                case "Medium 600-1k": ErrLevel := GetColors(49, 83, "0x5A5A5A", 40) 
                case "Low >600": ErrLevel := GetColors(49, 83, "0x5A5A5A", 40)
            }
            If (ErrLevel) {
                If (T10 != "Do nothing") {
                    Notify("Wait, " Delay1)
        ...
        If (T6 != "Strave") {
            If (!GetColors(64, 98, "0x444444", 10)) {
                Sleep, 2000
                Click, 410, 345
                Sleep, 1000
                Switch Eat("1-0", T6) {
